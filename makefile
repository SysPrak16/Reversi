...
main.o: main.c appParamHandler.h fileIOHandler.h connector.h
	$(CC) -c $(CFLAGS) -o main.o main.c

appParamHandler.o: appParamHandler.c appParamHandler.h
...
fileIOHandler.o: fileIOHandler.c fileIOHandler.h errorHandler.h	global.h
